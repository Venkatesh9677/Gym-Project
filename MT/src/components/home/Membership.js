...
const Membership = () => {
  ...
  <span className="section-subtitle">NO MATTER WHAT YOUR FITNESS LEVEL IS, LET'S FIND THE FITNESS MEMBERSHIP OPTIONS THAT WORK BEST FOR YOU</span>

      <div className="row membership-row">
 <div className="col-md-4 membership-card"><div>
 ...
 <h4 className="card-title membership-title">₹11999</h4>
  <p className="card-description membership-description">
   {/* Add description for Yearly Plan */}</p>
   </div>
...
<div className="col-md-4 membership-card active"><div>
