...
<div className="col-md-5"><img className="about-image img-fluid" src={AboutImage} alt="" /></div>
<div className="col-md-6"><h3 className="about-title">STORY ABOUT US</h3>

<p className="about-description"><p className="about-title1">Muscle Trainer Gym in Virugambakkam, Chennai</p>
